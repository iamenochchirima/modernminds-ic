          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                  ...
                  <i
                    className={`
                      fas fa-tv mr-2 text-sm ${
                        tab === 0 ? "opacity-75" : "text-blueGray-300"
                      }
                    `}
                  ></i>{" "}
                  Articles
                ...
                >
                  <i
                    className={`
                      ...
                      ${tab === 1 ? "opacity-75" : "text-blueGray-300"}
                    `}
                  ></i>
                  Settings
                </button>
                ...
                >
                  <i
                    className={`fas fa-map-marked mr-2 text-sm ${
                      tab === 2 ? "opacity-75" : "text-blueGray-300"
                    }`}
                  ></i>
                  Tables
                </button>
              ...
              <li className="items-center">
                ...
                >
                  <i
                    className={`fas fa-map-marked mr-2 text-sm ${ tab === 3 ? "opacity-75" : "text-blueGray-300"}`}
                  ></i>
                  Maps
                </button>
              </li>
