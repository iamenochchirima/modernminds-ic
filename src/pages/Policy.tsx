      ...
      <div className="md:w-3/4 mx-5">
        ...
        <div className="text-gray-800">
          <p>
            ...
            <a className="text-blue-600" href="https://www.modernmindsmag.com">
              https://www.modernmindsmag.com
            </a>
            , and other sites we own and operate.{" "}
          </p>
          <p className="pt-5">
            This policy is effective as of 4 April 2023 and was last updated on
            4 April 2023.{" "}
          </p>
          ...
          <ul className="list-disc px-10">
            ...
            <li>
              for security and fraud prevention, and to ensure that our site is
          ...
          <p>
            Our website is not directed toward children under the age of 13, and
            we do not knowingly collect personal information from children under
            the age of 13. If we discover that we have inadvertently collected
            personal information from a child under 13, we will promptly take
            steps to delete that information. If you are a parent or guardian
            and believe that your child under the age of 13 has provided
          ...
          <p className="pb-5">
            You have the right to view, edit or delete the personal data we have
            collected about you. Furthermore, you have the right to withdraw
            consent or to object to the processing of your personal data. And
            you have the right to data portability: this means that you can
            request that we send you, or another organization named by you, the
            personal data that we have about you in a computer file.
          </p>
          <p>
