...
const CreateArticle: FC<Props> = ({ setOpenCreateModal }) => {
  ...
  const saveArticle = async (data: FormData) => {
    console.log(data, coverfile, contentBody1Image, contentBody2Image, contentBody3Image, contentBody4Image, contentBody5Image, contentBody1, contentBody2, contentBody3, contentBody4, contentBody5)
    setIsLoading(true)
  }
