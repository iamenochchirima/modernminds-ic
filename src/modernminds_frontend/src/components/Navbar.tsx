...
import { setExploreOpen } from "../../state/globalSlice";
import { setAuthState, setCloseLoginViewState, setClosePasswordReset, setCloseRegisterViewState, setLogoutState, setOpenLoginViewState } from "../../state/authSlice";
...
const Navbar = () => {
  ...
  const { isExploreOpen } = useSelector((state: RootState) => state.global);
